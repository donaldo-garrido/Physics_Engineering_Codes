function trescuerpos_rkf3d(inter,ic,m1,m2,m3,n,p,nombre)
    ...
    y(1,:)=[x1 vx1 y1 vy1 z1 vz1 x2 vx2 y2 vy2 z2 vz2 x3 vx3 y3 vy3 z3 vz3]; %vector con todos los datos proporcionados
    t(1)=inter(1); % primer iteracion

    set(gca,'XLim',[-20 20],'YLim',[-20 20],'ZLim',[-20 20],'XTick',[-20 0 20],'YTick',[-20 0 20],'ZTick',[-20 0 20]);
    ...
    for k=1:n/p
        ...
        addpoints(object3_h,y(1,11),y(1,13),y(1,15))
        addpoints(object3_t,y(1,11),y(1,13),y(1,15))
        drawnow;
    end

end

function y=rkf(t,x,h,m1,m2,m3) %runge kuta de orden 4
...
function z=dependencia(t,x,m1,m2,m3) %el vector x es en realidad el vector y del inicio del programa
